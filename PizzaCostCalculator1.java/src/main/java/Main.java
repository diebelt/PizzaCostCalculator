...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Integer selectDiet = scanner.nextInt();

        if (selectDiet >= 1 && selectDiet <= diets.size()) {
            Diet diet = diets.get(selectDiet - 1);
            createPizza(size, diet, sizes, scanner, selectDiet);
        } else {
    ...
    public static void createPizza(String size, Diet diet, Map<String, Size> sizes, Scanner scanner, int selectDiet) {
        System.out.println("Choose your ingredients (enter 0 when done): ");

        Set<String> printedCategories = new HashSet<>();

        printToppingsByCategory(diet.getToppingList(), "Meat", printedCategories);
        printToppingsByCategory(diet.getToppingList(), "Fish", printedCategories);
        printToppingsByCategory(diet.getToppingList(), "Vegetable", printedCategories);
        printToppingsByCategory(diet.getToppingList(), "Cheese", printedCategories);
       ...
       List<Topping> addedIngredients = new ArrayList<>();
        ...
        do {
            ...
            printToppingsByCategory(diet.getToppingList(), categories.get(selectDiet - 1), printedCategories);
    ...
    private static void printToppingsByCategory(List<Topping> toppings, String category, Set<String> printedCategories) {
    ...
    public static ArrayList<ArrayList<Topping>> ToppingLists() {
        ...
        Cheese mozzarella = new Cheese("mozarella", 1.5);
